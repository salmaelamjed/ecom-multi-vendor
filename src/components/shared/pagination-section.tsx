...
export default function PaginationSection({
  ...
  const renderPages = () => {
    const renderedPages = activePages.map((page, idx) => (
      ...
      >
        <PaginationLink size="default" onClick={() => setCurrentPage(page)}>
          {page}
        </PaginationLink>
      </PaginationItem>
    ));
  ...
  return (
    <div className="p-4">
      <Pagination>
        <PaginationContent>
          <PaginationItem>
            <PaginationPreviousLast size="default" onClick={handlePrevPageLast} />
            <PaginationPrevious size="default" onClick={handlePrevPage} />
          </PaginationItem>
          ...
          <PaginationItem>
            ...
            <PaginationNextLast size="default" onClick={handleNextPageLast} />
          </PaginationItem>
        </PaginationContent>
      </Pagination>
    </div>
